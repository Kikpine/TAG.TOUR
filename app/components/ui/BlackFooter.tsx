...
function BlackFooter({}: Props) {
  return (
    <footer className="black-footer">
      <div id="homepage-buttons-and-text">
        <p className="gray-small-text-1"  id="paragraph-2">Создавайте уникальный контент и продвигай свой бизнес с помощью инструментов <span className="cyan-italic-text">tour+</span></p>
        <button className="black-button">Зарегистрироваться</button>
        <button className="black-button">Войти</button>
      </div>
      ...
      <div className="links-box">
        ...
        <div className="gray-small-text-2">concept</div>
        <div className="images-links-set">
        ...
        <div className="gray-small-text-2">© Concept. 2024 All rights reserved.</div>
      </div>
    </footer>
  )
}
